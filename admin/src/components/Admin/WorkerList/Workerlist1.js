...
export default function Workerlist1() {
    ...
    const rows = workers.map((item) => createData(item._id, item.deliver_ovog, item.deliver_name, item.deliver_rd, item.deliver_phone, item.deliver_email, item.deliver_address, item.deliver_date, item.deliver_type));
