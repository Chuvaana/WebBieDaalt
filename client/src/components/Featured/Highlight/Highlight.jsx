  ...
  return (
    <div className="home_featured__products__container">
      <div className="highlight">
        ...
        <div className="title">
          <p>Шинэ бүтээгдэхүүн</p>
        </div>
        <div className="list">
          <div
            className="first"
            onClick={jump1}
            style={{ backgroundImage: `url(${firstItem.image[0].path})` }}
          >
          ...
          <div className="second">
            <div
              className="s_first"
              onClick={jump2}
              style={{ backgroundImage: `url(${secondItem.image[0].path})` }}
            >
              <div className="inside">
            ...
            <div className="s_second">
              <div
                className="s_s_first"
                onClick={jump3}
                style={{ backgroundImage: `url(${thirdItem.image[0].path})` }}
              >
                <div className="inside">
                  <div style={{ color: "black" }} className="name">
                    {" "}
              ...
              <div
                className="s_s_second"
                onClick={jump4}
                style={{ backgroundImage: `url(${fourthItem.image[0].path})` }}
              >
                <div className="inside">
                  <div style={{ color: "black" }} className="name">
                    {" "}
