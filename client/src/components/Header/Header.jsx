                    ...
                    <div className='wishlist-icon-header'>
                        <Link to="/wishlist">
                            <Badge badgeContent={wishItems.items.length} color="error">
                                <svg fill="#000000" height="24px" width="24px" version="1.1" id="Capa_1" viewBox="0 0 471.701 471.701">
                                    <g>
                    ...
                    <div className='cart-icon'>
                        <Link to="/cart">
                            <Badge badgeContent={cartItems.items.length} color="error">
                                <svg viewBox="0 0 1024 1024" fill="currentColor" height="24px" width="24px">
                    ...
                    {profileVisible && (
                        <div className='profile'>
                            ...
                            <div className='item'>
                                ...
                                <a href='/account/login' onClick={handleClick}>Гарах</a>
                            </div>
                        </div>
                    )}
                </div>
