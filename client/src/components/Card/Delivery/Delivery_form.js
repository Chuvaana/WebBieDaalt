          ...
          <div className="delivery_address_body">
            ...
            >
              ...
              <Form.Item
                name="district"
                label="Хороо"
                rules={[{ required: true, message: "Хороогоо оруулна уу!" }]}
              >
                <Select
              ...
              <Form.Item
                name="horoo"
                label="Дүүрэг"
                rules={[{ required: true, message: "Дүүргээ оруулна уу!" }]}
              >
                <Select
                  value={selectedCity}
              ...
              <Form.Item
                ...
                rules={[
                  { required: true, message: "Хүлээн авах хаягаа оруулна уу!" },
                ]}
              >
                <Input onChange={(e) => setAddress(e.target.value)} />
              </Form.Item>

              <Form.Item name="addition" label="Нэмэлт мэдээлэл">
                ...
                <div className="type_payment">
                  <Radio.Group onChange={onChange} value={value}>
                    <Space direction="vertical">
                      <Radio style={{ fontSize: "17px" }} value={1}>
                        Банкаар шилжүүлэх
                      </Radio>
                      <Radio style={{ fontSize: "17px" }} value={2}>
                        Картаар төлөх
                      </Radio>
                    </Space>
                  </Radio.Group>
