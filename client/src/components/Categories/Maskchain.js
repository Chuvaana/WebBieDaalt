...
const plainOptions = ['Шүр', 'Төмөр']; // Add your color options here
    ...
    useEffect(() => {
        axios.get("http://localhost:5000/api/items")
            .then(res => {
                ...
                const ringItems = res.data.filter(item => item.category === 'maskchain');
    ...
    return (
        <div className="featured__products__container">
            ...
            <div className="itemsFrame">
                <div className='date'>
                    <p>Маскны гинж ( {ringItems.length} )</p>
                </div>
